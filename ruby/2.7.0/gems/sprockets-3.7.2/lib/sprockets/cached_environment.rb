...
module Sprockets
  ...
  class CachedEnvironment < Base
    ...
    alias _processor_cache_key processor_cache_key
    def processor_cache_key(str)
      @processor_cache_keys[str]
    end

    # Internal: Cache Environment#resolve_dependency
    alias _resolve_dependency resolve_dependency
    ...
    # should bomb.
    def config=(_config)
      raise "can't modify immutable cached environment"
    end
  end
end
