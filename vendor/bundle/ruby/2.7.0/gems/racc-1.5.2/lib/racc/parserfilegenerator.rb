...
module Racc
  class ParserFileGenerator
    ...
    def generate_parser_file(destpath)
      ...
      File.chmod 0o755, destpath if @params.make_executable?
    end
    ...
    def notice
      line '#'
      line '# DO NOT MODIFY!!!!'
      line %(# This file is automatically generated by Racc #{Racc::Version})
      line %(# from Racc grammar file "#{@params.filename}".)
      line '#'
    end
    ...
    def unique_separator(id)
      ...
      sep.concat format('%02x', rand(255)) while @used_separator.key?(sep)
    ...
    def serialize_integer_list_std(name, table)
      ...
      table.each_slice(10) do |ns|
        @f.print sep; sep = ",\n"
        @f.print ns.map { |n| format('%6s', n ? n.to_s : 'nil') }.join(',')
      end
      line ' ]'
    end
    ...
    def actions
      @grammar.each do |rule|
        raise 'racc: fatal: cannot generate parser file when any action is a Proc' unless rule.action.source?
      end
