  ...
  class Driver
    class Draft76 < Draft75
      ...
      def handshake_response
        ...
        raise ProtocolError, 'Missing required header: Sec-WebSocket-Key1' unless key1
        raise ProtocolError, 'Missing required header: Sec-WebSocket-Key2' unless key2
        ...
        if number1 % spaces1 != 0 or number2 % spaces2 != 0
          raise ProtocolError, 'Client sent invalid Sec-WebSocket-Key headers'
        end
